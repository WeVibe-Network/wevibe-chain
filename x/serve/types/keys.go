...
func NewServeAttestation(orgID string, contentHash []byte, serveKey, contributorID string, epoch uint64, nullifier []byte, isSelfServe bool, modelID string, turnCount uint32) *ServeAttestation {
